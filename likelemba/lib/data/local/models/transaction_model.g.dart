...
const TransactionModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'currency': PropertySchema(
      ...
      name: r'currency',
      type: IsarType.byte,
      enumMap: _TransactionModelcurrencyEnumValueMap,
    ),
    ...
    r'proofImagePath': PropertySchema(
      id: 4,
  ...
  links: {
    r'userLink': LinkSchema(
      id: -3398894625036581612,
      name: r'userLink',
      target: r'UserModel',
      single: true,
    ),
    r'groupLink': LinkSchema(
      id: 3962691784058898858,
      name: r'groupLink',
      target: r'LikelembaModel',
      single: true,
    ),
    r'recipientLink': LinkSchema(
      id: -8127999099230126697,
      name: r'recipientLink',
      target: r'UserModel',
      single: true,
    )
  },
...
TransactionModel _transactionModelDeserialize(
  ...
  object.currency = _TransactionModelcurrencyValueEnumMap[
...
P _transactionModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_TransactionModelcurrencyValueEnumMap[
              reader.readByteOrNull(offset)] ??
          TransactionCurrency.cdf) as P;
    case 2:
...
const _TransactionModelcurrencyEnumValueMap = {
  'cdf': 0,
  'usd': 1,
};
const _TransactionModelcurrencyValueEnumMap = {
  0: TransactionCurrency.cdf,
...
const _TransactionModelstatusValueEnumMap = {
  ...
  1: TransactionStatus.validated,
  2: TransactionStatus.rejected,
};
...
const _TransactionModeltypeValueEnumMap = {
  0: TransactionType.contribution,
  1: TransactionType.payout,
  2: TransactionType.penalty,
  3: TransactionType.refund,
  4: TransactionType.reserveFund,
};
...
List<IsarLinkBase<dynamic>> _transactionModelGetLinks(TransactionModel object) {
  return [object.userLink, object.groupLink, object.recipientLink];
}
...
void _transactionModelAttach(
  ...
  object.id = id;
  object.userLink
      .attach(col, col.isar.collection<UserModel>(), r'userLink', id);
  object.groupLink
      .attach(col, col.isar.collection<LikelembaModel>(), r'groupLink', id);
  object.recipientLink
      .attach(col, col.isar.collection<UserModel>(), r'recipientLink', id);
}
...
extension TransactionModelQueryWhereSort
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterWhere> anyTimestamp() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionModelQueryFilter
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      currencyEqualTo(TransactionCurrency value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'currency',
        value: value,
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      currencyBetween(
    TransactionCurrency lower,
    TransactionCurrency upper, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionModelQueryLinks
    on QueryBuilder<TransactionModel, TransactionModel, QFilterCondition> {
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      userLink(FilterQuery<UserModel> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      groupLink(FilterQuery<LikelembaModel> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      recipientLink(FilterQuery<UserModel> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'recipientLink');
    });
  }
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      recipientLinkIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'recipientLink', 0, true, 0, true);
    });
  }
}
...
extension TransactionModelQuerySortBy
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterSortBy>
      sortByProofImagePath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'proofImagePath', Sort.asc);
    });
  }

  QueryBuilder<TransactionModel, TransactionModel, QAfterSortBy>
      sortByProofImagePathDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'proofImagePath', Sort.desc);
    });
  }
...
extension TransactionModelQueryWhereDistinct
  ...
  QueryBuilder<TransactionModel, TransactionModel, QDistinct>
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'proofImagePath',
          caseSensitive: caseSensitive);
    });
  }
...
extension TransactionModelQueryProperty
  ...
  QueryBuilder<TransactionModel, TransactionCurrency, QQueryOperations>
      currencyProperty() {
    return QueryBuilder.apply(this, (query) {
